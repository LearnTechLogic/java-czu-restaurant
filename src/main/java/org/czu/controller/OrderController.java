...
public class OrderController {
    ...
    @FXML
    private TableColumn<Dish, Integer> TableColumn;

    @FXML
    private TableColumn<Dish, Integer> OrderIdColumn;
    ...
    private void initialize() {
        BindColumns.bindColumns(DishTable, ImageColumn, NameColumn, TableColumn, NumColumn, OrderIdColumn, StateColumn);
